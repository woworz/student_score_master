<template>
  <div>
    <el-card class="content" style="width: 55%;margin: 12px">
      ...
      <el-row style="color: #666666;padding: 18px">
        <el-col :span="6" style="margin-left: 5px;margin-top: 10px" class="upload" v-loading="loading">
          <!--头像上传-->
          <el-upload
            action=""
    ...
    <el-card class="content" style="width: 40%;margin: 12px 12px 12px 0">
